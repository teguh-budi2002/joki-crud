        ...
        <form method="post" action="{{ URL('/education') }}">
            ...
            <div class="grid grid-cols-2 gap-5">
                ...
                <div class="smp">
                    <div class="mb-6">
                        ...
                        <input type="text" name="sekolah_smp" id="sekolah_smp"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
                    </div>
                    <div class="mb-6">
                ...
                <div class="slta">
                    <div class="mb-6">
                        <label for="sekolah_slta" class="block mb-2 text-sm font-medium text-gray-900">Sekolah
                            SLTA</label>
                        <input type="text" name="sekolah_slta" id="sekolah_slta"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
                    </div>
                    <div class="mb-6">
                ...
                <div class="d-3">
                    <div class="mb-6">
                        <label for="sekolah_d3" class="block mb-2 text-sm font-medium text-gray-900">Sekola
                            D3/Akademi</label>
                        <input type="text" name="sekolah_d3" id="sekolah_d3"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
                    </div>
                    <div class="mb-6">
            ...
            <div class="grid grid-cols-2 gap-5">
                <div class="s1">
                    <div class="mb-6">
                        ...
                        <input type="text" name="sekolah_s1" id="sekolah_s1"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
                    </div>
                    <div class="mb-6">
                ...
                <div class="d-3">
                    <div class="mb-6">
                        ...
                        <input type="text" name="sekolah_s2" id="sekolah_s2"
                            class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
                    </div>
                    <div class="mb-6">
            ...
            <div class="s3 flex flex-col justify-center mt-4">
                <div class="mb-6">
                    ...
                    <input type="text" name="sekolah_s3" id="sekolah_s3"
                        class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600">
                </div>
                <div class="mb-6">
