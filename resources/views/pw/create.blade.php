...
<div class="w-full flex justify-center mt-28">
    ...
    <div class="w-3/5 bg-white shadow-md shadow-gray-400 p-3 rounded-md">
        <form method="post" action="{{ URL('power/and/weak/') }}">
            @csrf
            <div class="mb-6">
                ...
                <input type="text" name="answer1" id="answ-pw1"
            ...
            <div class="mb-6">
                ...
                <input type="text" name="answer2" id="answ-pw2"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600"
                    >
            </div>
            <div class="mb-6">
                ...
                <input type="text" name="answer3" id="answ-pw3"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600"
                    >
            </div>
            <button type="submit"
