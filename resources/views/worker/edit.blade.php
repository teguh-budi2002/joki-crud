@extends('app')
@section('content')
<div class="w-full flex justify-center mt-20 mb-9">
    @if ($errors->any())
        <ul>
    ...
    <div class="w-3/5 bg-white shadow-md shadow-gray-400 p-3 rounded-md">
        <form method="post" action="{{ URL('data/worker/' . $wk->id) }}">
            @csrf
            @method('PUT')
            <div class="mb-6">
                <label for="nama_perusahaan" class="block mb-2 text-sm font-medium text-gray-900">Nama Perusahaan</label>
                <input type="text" name="nama" value="{{ old('nama', $wk->nama) }}" id="nama_perusahaan"
            ...
            <div class="mb-6">
                ...
                <input type="text" name="tgl_mulai" id="tgl_mulai1" value="{{ old('tgl_mulai', $wk->tgl_mulai) }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600"
                    >
            </div>
            <div class="mb-6">
                <label for="tanggal_akhir1" class="block mb-2 text-sm font-medium text-gray-900">Tanggal Akhir</label>
                <input type="text" name="tgl_akhir" id="tanggal_akhir1" value="{{ old('tgl_akhir', $wk->tgl_akhir) }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600"
                    >
            </div>
            <div class="mb-6">
                <label for="jabatan" class="block mb-2 text-sm font-medium text-gray-900">Jabatan</label>
                <input type="text" name="jabatan" id="jabatan" value="{{ old('jabatan', $wk->jabatan) }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600"
                    >
            </div>
            <div class="mb-6">
                <label for="gaji" class="block mb-2 text-sm font-medium text-gray-900">Gaji</label>
                <input type="text" name="gaji" id="gaji" value="{{ old('gaji', $wk->gaji) }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600"
                    >
            </div>
            <div class="mb-6">
                <label for="uraian" class="block mb-2 text-sm font-medium text-gray-900">Uraian</label>
                <input type="text" name="uraian" id="uraian" value="{{ old('uraian', $wk->uraian) }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600"
                    >
            </div>
            <div class="mb-6">
                ...
                <input type="text" name="answer" id="answer" value="{{ old('answer', $wk->answer) }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600"
                    >
            </div>
