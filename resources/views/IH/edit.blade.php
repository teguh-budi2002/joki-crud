...
<div class="w-full flex justify-center mt-28">
    ...
    <div class="w-3/5 bg-white shadow-md shadow-gray-400 p-3 rounded-md">
        <form method="post" action="{{ URL('minat/' . $io->id) }}">
            @csrf
            @method('PUT')
            <div class="mb-6">
                ...
                <input type="text" name="answer1" id="answ1" value="{{ old('answer1', $io->answer1) }}"
            ...
            <div class="mb-6">
                ...
                <input type="text" name="answer2" id="answ2" value="{{ old('answer2', $io->answer2) }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600"
                    >
            </div>
            <div class="mb-6">
                <label for="answ3" class="block mb-2 text-sm font-medium text-gray-900">3.)  Apa yang anda capai, Jelaskan alasanya.</label>
                <input type="text" name="answer3" id="answ3" value="{{ old('answer3', $io->answer3) }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600"
                    >
            </div>
            <div class="mb-6">
                ...
                <input type="text" name="answer4" id="answ4" value="{{ old('answer4', $io->answer4) }}"
                    class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600"
                    >
            </div>
            <button type="submit"
